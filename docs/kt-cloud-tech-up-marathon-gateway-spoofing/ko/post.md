...
본 포스팅은 치열하게 진행 중인 **kt cloud TECH UP 실무 통합 프로젝트**의 일환으로 진행된 마라톤 티켓팅 플랫폼 구축기의 이어지는 기록입니다. (이전 글: [kt-cloud-tech-up-marathon-gradle-implementation](../kt-cloud-tech-up-marathon-gradle-implementation))
